...
if (isPortalRequest) {
  ...
  if (isProjectPortal && Array.isArray(lotsParsedPortal) && lotsParsedPortal.length) {
    for (const lot of lotsParsedPortal) {
      ...
      const bedsPrimary = lotProps && (lotProps.beds_primary || lotProps.bedsPrimary) ? String(lotProps.beds_primary || lotProps.bedsPrimary) : "";
      const bedsSecondary = lotProps && (lotProps.beds_additional__secondary__dual_key || lotProps.beds_secondary || lotProps.bedsSecondary) ? String(lotProps.beds_additional__secondary__dual_key || lotProps.beds_secondary || lotProps.bedsSecondary) : "";
      const bathPrimary = lotProps && (lotProps.bath_primary || lotProps.baths_primary || lotProps.bathPrimary) ? String(lotProps.bath_primary || lotProps.baths_primary || lotProps.bathPrimary) : "";
      const bathSecondary = lotProps && (lotProps.baths_additional__secondary__dual_key || lotProps.bath_secondary || lotProps.baths_secondary || lotProps.bathSecondary) ? String(lotProps.baths_additional__secondary__dual_key || lotProps.bath_secondary || lotProps.baths_secondary || lotProps.bathSecondary) : "";
      const garagePrimary = lotProps && (lotProps.garage_primary || lotProps.garagePrimary) ? String(lotProps.garage_primary || lotProps.garagePrimary) : "";
      const garageSecondary = lotProps && (lotProps.garage_additional__secondary__dual_key || lotProps.garage_secondary || lotProps.garageSecondary) ? String(lotProps.garage_additional__secondary__dual_key || lotProps.garage_secondary || lotProps.garageSecondary) : "";

      const landRegistration = lotProps && (lotProps.land_registration || lotProps.landRegistration) ? String(lotProps.land_registration || lotProps.landRegistration) : "";
      const buildSize = lotProps && (lotProps.build_size || lotProps.buildSize) ? String(lotProps.build_size || lotProps.buildSize) : "";
      const landSize = lotProps && (lotProps.land_size || lotProps.landSize) ? String(lotProps.land_size || lotProps.landSize) : "";
      const title = lotProps && lotProps.title ? String(lotProps.title) : "";
      const bodyCorpQuarter = lotProps && (lotProps.body_corp__per_quarter || lotProps.body_corp_per_quarter) ? String(lotProps.body_corp__per_quarter || lotProps.body_corp_per_quarter) : "";

      const bedsDisplay = bedsPrimary && bedsSecondary ? `${bedsPrimary} + ${bedsSecondary}` : (bedsPrimary || bedsSecondary || "");
      const bathsDisplay = bathPrimary && bathSecondary
        ? `${String(bathPrimary).replace(/point/gi, ".")} + ${String(bathSecondary).replace(/point/gi, ".")}`
        : (bathPrimary ? String(bathPrimary).replace(/point/gi, ".") : "");
      const garageDisplay = garagePrimary && garageSecondary ? `${garagePrimary} + ${garageSecondary}` : (garagePrimary || garageSecondary || "");

      if (bedsDisplay) {
        propertyDescHtmlPortal += htmlLine("Bed", bedsDisplay);
        propertyDescTextPortal += textLine("Bed", bedsDisplay);
      }
      if (bathsDisplay) {
        propertyDescHtmlPortal += htmlLine("Bath", bathsDisplay);
        propertyDescTextPortal += textLine("Bath", bathsDisplay);
      }
      if (garageDisplay) {
        propertyDescHtmlPortal += htmlLine("Garage", garageDisplay);
        propertyDescTextPortal += textLine("Garage", garageDisplay);
      }
      if (landRegistration) {
        propertyDescHtmlPortal += htmlLine("Registration", landRegistration);
        propertyDescTextPortal += textLine("Registration", landRegistration);
      }
      if (buildSize) {
        propertyDescHtmlPortal += htmlLine("Built", `${buildSize} sqm approx.`);
        propertyDescTextPortal += textLine("Built", `${buildSize} sqm approx.`);
      }
      if (landSize) {
        propertyDescHtmlPortal += htmlLine("Land Size", `${landSize} sqm approx.`);
        propertyDescTextPortal += textLine("Land Size", `${landSize} sqm approx.`);
      }
      if (title) {
        const titleDisplay = title
          ? String(title)
              ...
              .join(" ")
          : "";
        propertyDescHtmlPortal += htmlLine("Title", titleDisplay);
        propertyDescTextPortal += textLine("Title", titleDisplay);

        const titleUpper = String(title).replace(/_/g, " ").toUpperCase();
        ...
        if (showBodyCorp && bodyCorpQuarter) {
          propertyDescHtmlPortal += `<p style="margin-left: 20px;"><strong>Body corp.:</strong> Approx. $${bodyCorpQuarter} per quarter</p>`;
          propertyDescTextPortal += `    Body corp.: Approx. $${bodyCorpQuarter} per quarter\n`;
        }
      }
